...
class _DatePickerHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle dayStyle = headerTextTheme.displaySmall!.copyWith(color: dayColor);
    final TextStyle yearStyle = headerTextTheme.headlineSmall!.copyWith(color: yearColor,fontSize: 30);
    ...
    final Widget yearButton = IgnorePointer(
      ...
      child: _DateHeaderButton(
        ...
        child: Semantics(
          ...
          child: Text("${(int.parse(localizations.formatYear(selectedDate!).split('年')[0])-1911).toString().padLeft(2,'0')}年", style: yearStyle),
        ),
      ),
    );
...
//print(localizations.formatMediumDate(selectedDate));
    return Container(
      padding: padding,
      color: backgroundColor,
      child: Column(
...
//print((int.parse(localizations.formatMonthYear(displayedMonth).split('年')[0])-1911).toString()+'年'+localizations.formatMonthYear(displayedMonth).split('年')[1]);
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 8.0),
      child: Column(
        children: <Widget>[
          Container(
            ...
            child: Center(
              child: ExcludeSemantics(
                child: Text("${(int.parse(localizations.formatMonthYear(displayedMonth!).split('年')[0])-1911).toString().padLeft(2,'0')}年${localizations.formatMonthYear(displayedMonth!).split('年')[1]}",
...
class _MonthPickerState extends State<MonthPicker> with SingleTickerProviderStateMixin {
  ...
  /// 修改此處 DateTime(widget.lastDate.year, widget.lastDate.month - 1 ),lastDate.month多減1，僅能顯示到這個月為止
  ...
  void _handleMonthPageChanged(int monthPage) {
    setState(() {
      ...
      //print(_currentDisplayedMonthDate);
            ...
            child: NotificationListener<ScrollStartNotification>(
              ...
              child: NotificationListener<ScrollEndNotification>(
                ...
                child: PageView.builder(
                  ...
                  itemCount: _monthDelta(widget.firstDate!, widget.lastDate!),
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemCount: widget.lastDate!.year - widget.firstDate!.year, ///修改此處，僅能顯示到最後一年
      itemBuilder: (BuildContext context, int index) {
        final int year = widget.firstDate!.year + index;
        final bool isSelected = year == widget.selectedDate!.year;
        final TextStyle itemStyle = isSelected
            ? themeData.textTheme.headlineSmall!.copyWith(color: themeData.accentColor)
            : style;
        return InkWell(
          ...
          child: Center(
            child: Semantics(
              selected: isSelected,
              child: Text((int.parse(year.toString())-1911).toString(), style: itemStyle),
            ),
          ),
        );
      },
